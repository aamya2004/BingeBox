      ...
      {isShown == true ? (
        ...
        border-gray-400"
          >
            ...
            <h2 className="text-white px-4 pt-6 pb-3 font-bold">{item.original_title}</h2>
          ...
          <HiOutlineHeart
            ...
            type="button"
          ></HiOutlineHeart>
          <p className="text-gray-400 px-2  text-xs line-clamp-3">{item.overview}</p>
          </div>
        </div>
      ) : (
        <div
          className="min-w-[250px] flex flex-col hover:border-2 items-center"
          onMouseEnter={() => setIsHover(id)}
          onMouseLeave={() => setIsHover()}
        >
          <img
